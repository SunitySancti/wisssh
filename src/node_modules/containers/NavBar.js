...
export const NavBar = () => {
    ...
    const isNewWishPage = useLocation().pathname.split('/').at(3) === 'new';
        ...
        case 'my-wishes/items':
            BreadCrumbs = () => (
                <div className='bread-crumbs'>
                    ...
                    { isNewWishPage && <Option to='/my-wishes/items/new'>Новое желание</Option> }
                </div>
            );
            break;
