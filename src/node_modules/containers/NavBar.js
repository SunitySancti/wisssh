...
import { setLastActiveOptionCoords, setHighlighterCoordsInNavBar, animationSecondStep } from 'store/highlighterSlice'
...
export const NavBar = () => {
    ...
    // const currentOption = document.querySelector('.nav.option.active');

    useLayoutEffect(() => {
        dispatch(setLastActiveOptionCoords());
    },[]);

    useLayoutEffect(() => {
        dispatch(setHighlighterCoordsInNavBar());
        setTimeout(() => dispatch(animationSecondStep()), 400);
    },);
