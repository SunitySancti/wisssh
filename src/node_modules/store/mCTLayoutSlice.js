...
const multiColumnTapeLayoutSlice = createSlice({
    ...
    reducers: {
        ...
        setColumnsQty(state) {
            ...
            const outerSpacing = 33;
            const innerSpacing = 22;
            const columnMinimalWidth = 220;

            const columnsQty = Math.floor((layoutWidth - 2 * outerSpacing + innerSpacing) / (columnMinimalWidth + innerSpacing));
